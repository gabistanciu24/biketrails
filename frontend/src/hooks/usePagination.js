...
export const usePagination = ({
  ...
  const paginationRange = useMemo(() => {
    ...
    //calculating whether we want to show the left dots, right dots or both
    //we don't show dots just when there is just one page number to be inserted between
    //the sibling and the page limit
